...
(function () {
                        ...
                        if (q.length)
                            for (var q = q.slice(0), u, f = 0; f < q.length; f++) {
                                if (o.errorProof) try {
                                    u = q[f].call(this,
                                        k, h, e, g)
                                } catch (p) {} else u = q[f].call(this, k, h, e, g);
    ...
    (function () {
        ...
        CKEDITOR.tools = {
            ...
            normalizeCssText: function (a, c) {
                var e = [],
                    i, d = CKEDITOR.tools.parseCssText(a, true, c);
    ...
    CKEDITOR.dom.element.setMarker = function (a, d, b, c) {
        var e = d.getCustomData("list_marker_id") || d.setCustomData("list_marker_id", CKEDITOR.tools.getNextNumber()).getCustomData("list_marker_id"),
            i = d.getCustomData("list_marker_names") || d.setCustomData("list_marker_names", {}).getCustomData("list_marker_names");
        a[e] = d;
        i[b] = 1;
            ...
            removeStyle: function (a) {
                ...
                if (!b.removeProperty && (a == "border" || a == "margin" || a == "padding")) {
                    ...
                    for (var b = [], h = 0; h < c.length; h++)
                        if (d)
                            for (var k = 0; k < d.length; k++) b.push([a, c[h], d[k]].join("-"));
        ...
        function a(a, b) {
            ...
            if (!a && !this._.guardLTR) {
                var h = f.type == CKEDITOR.NODE_ELEMENT ? f : f.getParent(),
                    t = f.type == CKEDITOR.NODE_ELEMENT ? f.getChild(d) : f.getNext();
            ...
            if (a && !this._.guardRTL) {
                var g = e.type == CKEDITOR.NODE_ELEMENT ? e : e.getParent(),
                    k = e.type == CKEDITOR.NODE_ELEMENT ? o ? e.getChild(o - 1) : null : e.getPrevious();
            ...
            if (this.current) f = this.current[i](false, n, m);
            else {
                if (a) f.type ==
            ...
            e = function (a, b, c, e) {
                ...
                if (f.type == CKEDITOR.NODE_TEXT) {
                    ...
                    if (i >= f.getChildCount()) {
                        ...
                        m = true
                    } else f = f.getChild(i).getPrevious();
                else {
                ...
                for (c = n; c < h.length; c++) {
                    ...
                    if (!i[c] || k.$.parentNode != i[c].$.parentNode)
                        for (k = k.getPrevious(); k;) {
                            ...
                            l = k.getPrevious();
                            if (b == 2) t.$.insertBefore(k.$.cloneNode(true), t.$.firstChild);
                            else {
                                k.remove();
        ...
        CKEDITOR.dom.range.prototype = {
            ...
            createBookmark2: function () {
                function a(b) {
                    ...
                    if (c.type == CKEDITOR.NODE_TEXT) {
                        f = c;
                        for (d = 0;
                            (f = f.getPrevious()) && f.type == CKEDITOR.NODE_TEXT;) d = d + f.getLength();
                        e = e + d
                    }
                    b.container = c;
                    b.offset = e
            ...
            getBoundaryNodes: function () {
                ...
                if (b.type == CKEDITOR.NODE_ELEMENT) {
                    f = b.getChildCount();
                    if (f > e) b = b.getChild(e).getPreviousSourceNode(true);
            ...
            enlarge: function (a, b) {
                ...
                case CKEDITOR.ENLARGE_ELEMENT:
                    ...
                    for (j = c(j); j || n;) {
                        ...
                        for (; n;) {
                            t = false;
                            if (n.type == CKEDITOR.NODE_COMMENT) n = n.getPrevious();
                            else {
                    ...
                    if (t.type == CKEDITOR.NODE_TEXT)
                        if (CKEDITOR.tools.trim(t.substring(l)).length) h = true;
                        else {
                            h = !t.getLength();
                            if (l == t.getLength()) {
                ...
                case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                    ...
                    var H, v, x = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? {
                            br: 1
                        } : null),
                        C = null,
                        D = function (a) {
            ...
            shrink: function (a, b, c) {
                if (!this.collapsed) {
                    ...
                    if (f && f.type == CKEDITOR.NODE_TEXT)
                        if (i)
                            if (i >= f.getLength()) e.setStartAfter(f);
                            else {
                                e.setStartBefore(f);
                                m = 0
                            } else e.setStartBefore(f); if (d && d.type == CKEDITOR.NODE_TEXT)
                        if (h)
                            if (h >= d.getLength()) e.setEndAfter(d);
                            else {
                                e.setEndAfter(d);
                                j = 0
            ...
            moveToClosestEditablePosition: function (a, b) {
                var c = new CKEDITOR.dom.range(this.root),
                    e = 0,
                    f, d = [CKEDITOR.POSITION_AFTER_END, CKEDITOR.POSITION_BEFORE_START];
            ...
            getNextParagraph: function (a) {
                ...
                for (this._.nextNode = null; p;) {
                    var y = 0,
                        ...
                        j = 0;
                    if (m) p.type == CKEDITOR.NODE_TEXT && e.test(p.getText()) && (m = 0);
                    else {
                        var n = p.getName();
                    ...
                    if (g && !y)
                        for (; !p.getNext(l) && !s;) {
                            n = p.getParent();
                            if (n.isBlockBoundary(this.forceBrBreak && !A && {
                                br: 1
                            })) {
                                y = 1;
                                m = 0;
                        ...
                        for (var d = f.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || f.name == "body", m, j = e.length; j > 0;) {
                            ...
                            if (d && (i.type == CKEDITOR.NODE_TEXT || i.type == CKEDITOR.NODE_ELEMENT && n.$inline[i.name])) {
                                ...
                                f.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT && (i.type ==
                                    CKEDITOR.NODE_ELEMENT && !n[f.name][i.name]) && c.push({
                                    check: "el-up",
                                    el: i
                                })
                            }
            ...
            for (d in e)
                if (d == "class") {
                    ...
                    for (i = a.classes.join("|"); m =
                        c.pop();)
                        if (i.indexOf(m) == -1) return false
                } else if (a.attributes[d] != e[d]) return false;
            for (j in f)
                if (a.styles[j] != f[j]) return false;
            return true
        }
        ...
        CKEDITOR.filter.prototype = {
            allow: function (a, c, e) {
                ...
                if (typeof a == "string") a = g(a);
                    ...
                    e[d.element] = d = {
                        styles: d.styles,
                        requiredStyles: d.styles && CKEDITOR.tools.objectKeys(d.styles)
                    };
                    if (a) {
                        a = r(a);
                ...
                for (j in a) {
                    d = a[j];
                    d = typeof d == "boolean" ? {} : typeof d == "function" ? {
                        match: d
                    } : r(d);
            ...
            check: function (a, b, e) {
                ...
                if (CKEDITOR.tools.isArray(a)) {
                    for (var f = a.length; f--;)
                        if (this.check(a[f], b, e)) return true;
                    return false
                }
                var d, j;
                if (typeof a == "string") {
    ...
    (function () {
        function a(a, c, i) {
            ...
            if (c !== void 0) {
                ...
                } else throw Error("Expect element of type CKEDITOR.dom.element."); if (CKEDITOR.env.ie && CKEDITOR.env.quirks && i == CKEDITOR.ELEMENT_MODE_INLINE) throw Error("Inline element mode is not supported on IE quirks.");
        ...
        function o(a) {
            ...
            if (e) var j = RegExp("(?:^|,)(?:" + e.replace(/\s*,\s*/g, "|") + ")(?=,|$)",
                ...
                c = c.replace(j, ""),
                c = c + ("," + e);
            if (d) var i = RegExp("(?:^|,)(?:" + d.replace(/\s*,\s*/g, "|") + ")(?=,|$)", "g"),
                c = c.replace(i, "");
        ...
        CKEDITOR.htmlParser.fragment.fromHtml =
            function (i, g, l) {
                ...
                f.onText = function (a) {
                    ...
                    var b = m.name,
                        i = b ? CKEDITOR.dtd[b] || (m._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c;
                    if (!j && !i["#"] && b in d) {
                        f.onTagOpen(e[b] || "");
                        f.onText(a)
                    } else {
    ...
    (function () {
        ...
        a.prototype = {
            ...
            addMany: function (a,
                c, e) {
                for (var d = [this.findIndex(c), 0], g = 0, l = a.length; g < l; g++) d.push({
                    value: a[g],
                    priority: c,
                    options: e
                });
    ...
    (function () {
                ...
                return function (d) {
                    if (d.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        ...
                        if (j = CKEDITOR.env.opera && !a || (typeof e == "function" ? e(d) !==
                            false : e))
                            if (!h && !CKEDITOR.env.needsBrFiller && d.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT) j = false;
                            else if (!h && !CKEDITOR.env.needsBrFiller && (document.documentMode > 7 || d.name in CKEDITOR.dtd.tr || d.name in CKEDITOR.dtd.$listItem)) j = false;
                        else {
                            j = b(d);
        ...
        function p(a, b) {
            for (var c = [], e = b.config.protectedSource, d = b._.dataStore || (b._.dataStore = {
                id: 1
            }), f = /<\!--\{cke_temp(comment)?\}(\d*?)--\>/g, e = [/<script[\s\S]*?<\/script>/gi, /<noscript[\s\S]*?<\/noscript>/gi].concat(e), a = a.replace(/<\!--[\s\S]*?--\>/g, function (a) {
        ...
        var y = /(?:&nbsp;|\xa0)$/,
            ...
            n = CKEDITOR.tools.extend({}, m.$blockLimit, m.$block),
            r = {
                elements: {
                    input: l,
                    textarea: l
        ...
        CKEDITOR.editable = CKEDITOR.tools.createClass({
            ...
            proto: {
                ...
                insertElementIntoRange: function (a, b) {
                    ...
                    if (j)
                        for (;
                            (n = b.getCommonAncestor(0, 1)) && (i = CKEDITOR.dtd[n.getName()]) && (!i || !i[e]);)
                            if (n.getName() in CKEDITOR.dtd.span) b.splitElement(n);
                    ...
                    if (this.insertElementIntoRange(a, e)) {
                        ...
                        if (m)
                            if ((m = a.getNext(function (a) {
                                return c(a) && !h(a)
                            })) && m.type == CKEDITOR.NODE_ELEMENT && m.is(CKEDITOR.dtd.$block)) m.getDtd()["#"] ? e.moveToElementEditStart(m) : e.moveToElementEditEnd(a);
        ...
        var q = function () {
                ...
                function b(c, d) {
                    ...
                    for (var t =
                        ...
                        if (a(e)) {
                            m = e.getName();
                            if (s && m in CKEDITOR.dtd.$list) g = g.concat(b(e, d));
                            else {
                                i = !!t[m];
                ...
                function j(b, c) {
                    ...
                    var e = c.endContainer.getChild(c.endOffset),
                        j = c.endContainer.getChild(c.endOffset - 1);
                    e && d(e, b[b.length - 1]);
                    if (j && d(j, b[0])) {
                ...
                return function (i, h, k) {
                    var r = i.editor;
                    i.getDocument();
                    var o = r.getSelection().getRanges()[0],
                        q = false;
                    ...
                    if (!o.checkReadOnly()) {
                        var v = (new CKEDITOR.dom.elementPath(o.startContainer, o.root)).blockLimit || o.root,
                            h = {
                                type: h,
                                dontFilter: q,
                                editable: i,
                        ...
                        if (x = k) {
                            ...
                            if (/^\s+|\s+$/.test(k) && "span" in CKEDITOR.dtd[z]) var s = '<span data-cke-marker="1">&nbsp;</span>',
                                k = s + k + s;
                            k = h.editor.dataProcessor.toHtml(k, {
                                context: null,
                                fixForBody: false,
                            ...
                            for (j(C, E); x < C.length; x++) {
                                ...
                                if (u = D.isLineBreak) {
                                    ...
                                    if (D.hasBlockSibling) u = 1;
                                        ...
                                        if (!M || !M.is({
                                            ...
                                            U = M.getPosition(L);
                                            if (U == CKEDITOR.POSITION_IDENTICAL || U == CKEDITOR.POSITION_CONTAINS) u = 0;
                                            else {
                                                L = u.splitElement(M);
                                                u.moveToPosition(L,
                                                    CKEDITOR.POSITION_AFTER_START);
                                ...
                                if (u) q = x > 0;
                                    ...
                                    if (R) {
                                        ...
                                        R = 0
                                    } else E.insertNode(D.node); if (D.lastNotAllowed && x < C.length - 1) {
                        ...
                        if (Q)
                            for (; F = Q.pop();) CKEDITOR.env.needsBrFiller ? F.appendBogus() :
                        ...
                        if (!h.dontMoveCaret) {
                            for (F = a(K.startContainer) && K.startContainer.getChild(K.startOffset - 1); F && a(F) && !F.is(n.$empty);) {
                                if (F.isBlockBoundary()) K.moveToPosition(F, CKEDITOR.POSITION_BEFORE_END);
                                else {
    ...
    (function () {
        ...
        var p = typeof window.getSelection != "function",
            y = 1;
        CKEDITOR.dom.selection = function (a) {
            ...
            if (CKEDITOR.env.webkit)(b.type == "None" && this.document.getActive().equals(a) || b.type == "Caret" && b.anchorNode.nodeType == CKEDITOR.NODE_DOCUMENT) && l(a, b);
            else if (CKEDITOR.env.gecko) b && (this.document.getActive().equals(a) && b.anchorNode && b.anchorNode.nodeType == CKEDITOR.NODE_DOCUMENT) && l(a, b, true);
            else if (CKEDITOR.env.ie) {
                var d;
                try {
                    d = this.document.getActive()
                } catch (e) {}
                if (p) b.type == "None" && (d && d.equals(this.document.getDocumentElement())) && l(a, null, true);
                else {
            ...
            var f, i;
            if (d)
                if (d.getRangeAt) f = (i = d.rangeCount && d.getRangeAt(0)) && new CKEDITOR.dom.node(i.commonAncestorContainer);
                else {
                    try {
                        i = d.createRange()
                    } catch (g) {}
            ...
            getRanges: function () {
                var a = p ? function () {
                    ...
                    var b = function (b, c) {
                        ...
                        return {
                            container: n,
                            offset: k > 0 ? -g : n.nodeValue.length + g
                        }
                    };
                    return function () {
                        ...
                        if (g) this.fake(g);
                            ...
                            if (p) {
                                ...
                                if ((d = g.getEnclosedNode()) && d.type == CKEDITOR.NODE_ELEMENT && d.getName() in A && (!d.is("a") || !d.getText())) try {
                                    ...
                                    q.select();
                                    return
                                } catch (s) {}(g.startContainer.type == CKEDITOR.NODE_ELEMENT && g.startContainer.getName() in b || g.endContainer.type == CKEDITOR.NODE_ELEMENT && g.endContainer.getName() in b) && g.shrink(CKEDITOR.NODE_ELEMENT, true);
                                q = g.createBookmark();
                                b = q.startNode;
                                if (!a) f = q.endNode;
        ...
        if (!b) {
            ...
            this.on("selectionChange", function (a) {
                for (var d = 0; d < b.length; d++) {
                    var i = b[d],
                        g = i.style.checkActive(a.data.path) ? CKEDITOR.TRISTATE_ON : CKEDITOR.TRISTATE_OFF;
                    i.fn.call(this, g)
                }
            })
        }
    ...
    (function () {
                ...
                for (o.getPosition(n) == CKEDITOR.POSITION_FOLLOWING && (o = 0); o;) {
                    ...
                    if (o.equals(n)) {
                        ...
                        var s = o.type == CKEDITOR.NODE_ELEMENT ? o.getName() : null,
                            p = s && o.getAttribute("contentEditable") == "false",
                        ...
                        if (p && j && CKEDITOR.dtd.$block[s])
                            for (var t = o, w = c(t), A = void 0, B = w.length, G = 0, t = B && new CKEDITOR.dom.range(t.getDocument()); G < B; ++G) {
                                var A = w[G],
                                    J = CKEDITOR.filter.instances[A.data("cke-filter")];
                                if (J ? J.check(this) : 1) {
                        ...
                        if (w)
                            if ((w = o.getParent()) && ((w.getDtd() || CKEDITOR.dtd.span)[f] || i) && (!g.parentRule || g.parentRule(w))) {
                                ...
                                if (s == CKEDITOR.NODE_TEXT || p || s == CKEDITOR.NODE_ELEMENT && !o.getChildCount()) {
                                    for (var s = o, W;
                                        (h = !s.getNext(I)) && (W = s.getParent(), k[W.getName()]) && (W.getPosition(m) | H) == H && (!g.childRule || g.childRule(W));) s = W;
                                    q.setEndAfter(s)
                                }
                            } else h = true;
                        else h = true;
                        ...
                        for (var h = y(this, e), p = h.hasAttributes(), r = q.getCommonAncestor(), s = {}, w = {}, A = {}, B = {}, S, P, Y; h && r;) {
                            if (r.getName() == f) {
                                ...
                                for (P in g.styles)
                                    if (!A[P] && (Y = r.getStyle(P))) h.getStyle(P) == Y ? s[P] = 1 : A[P] = 1
                            }
                            r = r.getParent()
                        }
        ...
        function m(a, b) {
            for (var c in a) a[c] = a[c].replace(G, function (a,
                c) {
                return b[c]
            })
        }
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.text.prototype, {
        ...
        split: function (a) {
            var d = this.$.parentNode,
                ...
                c = this.getLength(),
                e = this.getDocument(),
                i = new CKEDITOR.dom.text(this.$.splitText(a), e);
    ...
    (function () {
        function a(a, c, d) {
            var i = a.serializable,
                ...
                h = i ? c.document.getById(a.startNode) : a.startNode,
                a = i ? c.document.getById(a.endNode) : a.endNode;
    ...
    CKEDITOR.plugins.link = {
        ...
        getEditorAnchors: function (b) {
            for (var a = b.editable(), d = a.isInline() && !b.plugins.divarea ? b.document : a, c = d.getElementsByTag("a"), a = [], f = 0, e; e = c.getItem(f++);)
                if (e.data("cke-saved-name") || e.hasAttribute("name")) a.push({
                    name: e.data("cke-saved-name") || e.getAttribute("name"),
                    id: e.getAttribute("id")
                });
            if (this.fakeAnchor) {
                d = d.getElementsByTag("img");
                for (f = 0; e = d.getItem(f++);)(e = this.tryRestoreFakeAnchor(b, e)) && a.push({
