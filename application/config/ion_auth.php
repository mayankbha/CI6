 ...
 */
$config['site_title']                 = 'Health Freaks';       // Site Title, example.com
$config['admin_email']                = 'admin@healthfreakslive.com'; 	// Admin Email, admin@example.com
...
$config['forgot_password_expiration'] = 7200;                   // The number of milliseconds after which a forgot password request will expire. If set to 0, forgot password requests will not expire.
...
$config['error_start_delimiter']   = '<p style="color: red;">';		// Error mesage start delimiter
