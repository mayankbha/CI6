...
<div class="sub-container">
    ...
    <div class="col-xs-12">
		...
		<a href="http://healthfreakslive.com">
			<div class="col-xs-12">
...
<script>
	...
	$(document).ready(function() {
		$("#fitness-schedule").load("<?php echo c_site_url('user_public_profile/get_user_fitness_schedule/'.$uid) ?>");
	});
	...
	function get_user_meal_schedule() {
		$("#meal-schedule").load("<?php echo c_site_url('user_public_profile/get_user_meal_schedule/'.$uid) ?>");
	}
	
	function get_user_meal_photos() {
		$("#meal-photos").load("<?php echo c_site_url('user_public_profile/get_user_meal_photos/'.$uid) ?>");
	}
	
	function get_user_self_photos() {
		$("#selfie-photos").load("<?php echo c_site_url('user_public_profile/get_user_self_photos/'.$uid) ?>");
	}

	function get_user_tips() {
		$("#tips").load("<?php echo c_site_url('user_public_profile/get_user_tips/'.$uid) ?>");
	}

	function get_user_videos() {
		$("#videos").load("<?php echo c_site_url('user_public_profile/get_user_videos/'.$uid) ?>");
	}
