...
<div class="sub-container">
    <div id="box-bg">
        ...
        <div class="col-xs-12 col-sm-12 col-lg-12">
                ...
                <?php foreach($print_record_details as $key => $print_record_detail) { ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-12 col-sm-6 col-lg-6"><?php echo $print_record_detail; ?></div>
                    </div>
                <?php } ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-6 col-lg-6">
                        <button type="button" name="submit" value="1" class="btn btn-browe" onclick="window.print();">PRINT</button>
                    </div>
                </div>
