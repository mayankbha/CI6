...
<html>
	...
	<body style='font-family: Verdana; font-size: 13px;'>
		...
		<p><span class='confirm' style=''>To confirm your email address click on the link below or copy & paste the link into the address bar within your browser. </span></p>

		<p>
			<div style='height: 49px;'>
				<br>
				<center>
					<span style='color: #1155CC; text-align: end; font-weight: bold;'>
